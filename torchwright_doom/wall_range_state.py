    ...
    def publish(
        ...
        return cls(
            dc_tmid_mid=_seg_keyed_lookup(
                past, "seg_dc_tmid_mid",
                active_dc_mid, seg_key_kpart, inp.value_v3,
            ),
            dc_tmid_upper=_seg_keyed_lookup(
                past, "seg_dc_tmid_upper",
                active_dc_upper, seg_key_kpart, inp.value_v4,
            ),
            dc_tmid_lower=_seg_keyed_lookup(
                past, "seg_dc_tmid_lower",
                active_dc_lower, seg_key_kpart, inp.value_v4,
            ),
            has_mid=_seg_keyed_lookup(
                past, "seg_has_mid",
                active_kpart, seg_key_kpart, inp.seg_kpart_has_mid,
            ),
            has_upper=_seg_keyed_lookup(
                past, "seg_has_upper",
                active_kpart, seg_key_kpart, inp.seg_kpart_has_upper,
            ),
            has_lower=_seg_keyed_lookup(
                past, "seg_has_lower",
                active_kpart, seg_key_kpart, inp.seg_kpart_has_lower,
            ),
            K_part_0=_seg_keyed_lookup(
                past, "seg_K_part_0",
                active_kpart, seg_key_kpart, inp.seg_kpart_K_part_0,
            ),
            K_part_1=_seg_keyed_lookup(
                past, "seg_K_part_1",
                active_kpart, seg_key_kpart, inp.seg_kpart_K_part_1,
            ),
            K_part_2=_seg_keyed_lookup(
                past, "seg_K_part_2",
                active_kpart, seg_key_kpart, inp.seg_kpart_K_part_2,
            ),
            rw_distance=_seg_keyed_lookup(
                past, "seg_rw_distance", active, seg_key, rw_distance_value,
            ),
            h_idx_oh_mid=_seg_keyed_lookup(
                past, "seg_h_idx_oh_mid", active, seg_key, h_idx_oh_mid_val,
            ),
            h_idx_oh_upper=_seg_keyed_lookup(
                past, "seg_h_idx_oh_upper", active, seg_key, h_idx_oh_upper_val,
            ),
            h_idx_oh_lower=_seg_keyed_lookup(
                past, "seg_h_idx_oh_lower", active, seg_key, h_idx_oh_lower_val,
            ),
        )
